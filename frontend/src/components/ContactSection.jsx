...
function ContactSection() {
  ...
  return (
    <section className="text-gray-600 body-font relative m-8 border-zinc-800 rounded-lg"id='contact'>
       {userLocation && (
        <div 
      ...
      <div className="container px-5 py-24 mx-auto flex">
        <form className="lg:w-1/3 md:w-1/2 bg-white rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-2 shadow-md">
