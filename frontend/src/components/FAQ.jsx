...
const FAQ = () => {
  ...
  return (
    <section id="faq" className="py-12 sm:py-16 bg-gray-900">
      <div className="container mx-auto px-4">
        <div className="text-center mb-8 sm:mb-12">
          <h2 className="text-2xl sm:text-3xl font-bold mb-3 sm:mb-4 text-white">Frequently Asked Questions</h2>
        ...
        <div className="max-w-3xl mx-auto">
          {faqs.map((faq, index) => (
            <div key={faq.id} className="mb-3 sm:mb-4">
              <button
                className={`flex justify-between items-center w-full p-3 sm:p-5 font-medium text-left rounded-lg ${
                  activeIndex === index
              ...
              >
                ...
                <svg
                  className={`w-5 h-5 sm:w-6 sm:h-6 flex-shrink-0 transition-transform duration-300 ${activeIndex === index ? 'rotate-180' : ''}`}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
              ...
              >
                <div className="p-3 sm:p-5 bg-gray-800 border border-gray-700 rounded-b-lg shadow-inner">
