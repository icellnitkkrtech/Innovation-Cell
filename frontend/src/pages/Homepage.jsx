...
const Homepage = () => {
  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen">
      ...
      <motion.div
        initial="hidden"
        animate="visible" /* ensure it's visible even if intersection observer doesn't trigger */
        // whileInView="visible"
        // viewport={{ once: true, amount: 0.3 }}
        variants={fadeIn}
        id="team-section-debug"
      >
        <Teamcard1 />
      </motion.div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="mt-3 max-w-2xl mx-auto text-xl text-gray-300">
                Join us for exciting events and opportunities to connect with
